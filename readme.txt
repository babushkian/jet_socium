...
В калсеес семья все слишком запутано. Методы вызываются из разных мест, нет единого подхода.
Нужен один метод, который должен отслеживать изменеия в классе.

Настолько запутался в классе Family, что не могу без ошибок обрабатывать любимчиков. Допустим,
любимчик умирает в 18 лет - он обрабатывается не как семья, а как человек,поэтому не удаляется
из семьи, как повзрослевший. А просто вызывает ввборы нового любимчика из-за смерти. А там, я
ее понял - какой-то то ли новый восемнадцатилетний человек, то ли тот же самый обваливает
функцию рандом, потому что она вызывается по нулевому диапазону (18-18).
Бросаю так, завтра буду разбираться.
