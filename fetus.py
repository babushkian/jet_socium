...
class Fetus:
	...
	def __init__(self, mother, gender=None):
		...
		if gender == None:
			...
			self.gender = gender
		if mother is None: # трудно себе такую ситуацию представить
			self.father = None
			self.mother = None
		else:
			self.father = mother.spouse # в момент зачатия муж в любом сдучае есть
			self.mother = mother
		self.age = ZERO_DATE
	...
	def get_gender_parents(self) ->Tuple:
